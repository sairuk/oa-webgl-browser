...
var mapShaders = [
    ...
    'scripts/skin.shader', 'scripts/sky.shader', 'scripts/test.shader', 'scripts/devilpunch.shader',
    'scripts/hub3aeroq3a.shader','scripts/mkoxide.shader','/scripts/gpl-q3a2oa-textures.shader',
    'scripts/hub3aeroq3.shader','scripts/ik_sky.shader', 'scripts/web_demo.shader'
];
